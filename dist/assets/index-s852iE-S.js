...
`,p=n((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n})),m=n(((e,t)=>{t.exports=p()}))();function h(){return(0,d.useEffect)(()=>{let n=!1;try{n=JSON.parse(localStorage.getItem(`atiga-state`)||`{}`)?.onboarded===!0}catch{}let r=document.getElementById(`welcome-dialog`);!e()&&!n&&r instanceof HTMLDialogElement&&!r.open&&r.showModal();let i=0,a=window.requestAnimationFrame(()=>{i=window.setTimeout(()=>{t(()=>import(`./app-DSSLOePP.js`),__vite__mapDeps([0,1,2]))},0)});return()=>{window.cancelAnimationFrame(a),i&&window.clearTimeout(i)}},[]),(0,m.jsx)(`div`,{dangerouslySetInnerHTML:{__html:f}})}var g=document.getElementById(`root`);if(!g)throw Error(`Elemen root React tidak ditemukan.`);(0,u.createRoot)(g).render((0,m.jsx)(h,{})),!e()&&`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(console.error)});