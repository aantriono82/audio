...
`,h=i((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n})),g=i(((e,t)=>{t.exports=h()}))();function _(){return(0,p.useEffect)(()=>{let n=!1;try{n=JSON.parse(localStorage.getItem(`atiga-state`)||`{}`)?.onboarded===!0}catch{}let r=document.getElementById(`welcome-dialog`);!e()&&!n&&r instanceof HTMLDialogElement&&!r.open&&r.showModal();let i=0,a=window.requestAnimationFrame(()=>{i=window.setTimeout(()=>{t(()=>import(`./app-DeOaOZ1s.js`),__vite__mapDeps([0,1,2]))},0)});return()=>{window.cancelAnimationFrame(a),i&&window.clearTimeout(i)}},[]),(0,g.jsx)(`div`,{dangerouslySetInnerHTML:{__html:m}})}n({desktop:e()});var v=document.getElementById(`root`);if(!v)throw Error(`Elemen root React tidak ditemukan.`);(0,f.createRoot)(v).render((0,g.jsx)(_,{})),!e()&&`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>r(`service_worker.register_failed`,e))});